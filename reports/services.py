...
def build_report_context(user, start, end, sections=None, organization=None,
    ...
    # ---- COUNTS (aggregated in the database) + FULL DETAIL ROWS ----
    ...
    # No row caps - every matching row is included in the report.
    ...
    return {
        ...
        "organization_label": organization.name if organization else "All organizations",
